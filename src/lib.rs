...
//!         R: Pin<Direction = RX>,
//!     {
//!         let _same_module: [u32; 1] = [0; (T::MODULE == R::MODULE) as usize];
...
//! # impl imxrt_iomuxc::uart::Pin for AD_B0_03 { const ALT: u32 = 0; type Direction = imxrt_iomuxc::uart::TX; const MODULE: usize = 1; const DAISY: Option<imxrt_iomuxc::Daisy> = None; }
//! # impl imxrt_iomuxc::uart::Pin for AD_B0_04 { const ALT: u32 = 0; type Direction = imxrt_iomuxc::uart::RX; const MODULE: usize = 1; const DAISY: Option<imxrt_iomuxc::Daisy> = None; }
//!
...
pub mod prelude {
    ...
    pub use crate::{gpio, i2c, pwm, spi, uart, Daisy, ErasedPad, Pad, WrongPadError};
}
...
/// `Pad`s have no size.
#[derive(Debug)]
pub struct Pad<Base, const OFFSET: usize> {
...
impl<Base, const OFFSET: usize> Pad<Base, OFFSET> {
...
unsafe impl<Base, const OFFSET: usize> Send for Pad<Base, OFFSET> where Base: Send {}
...
unsafe impl<Base, const OFFSET: usize> crate::IOMUX for Pad<Base, OFFSET>
where
    Base: crate::Base,
{
    /// # Safety
...
/// # type AD_B0_03 = iomuxc::Pad<AD_B0, 3>;
/// let ad_b0_03 = unsafe { AD_B0_03::new() };
...
impl<Base, const OFFSET: usize> ::core::convert::TryFrom<ErasedPad> for Pad<Base, OFFSET>
where
    Base: crate::Base,
{
...
/// struct AD_B0; unsafe impl imxrt_iomuxc::Base for AD_B0 { fn mux_base() -> *mut u32 { 0 as *mut u32 } fn pad_base() -> *mut u32 { 0 as *mut u32 } }
/// type AD_B0_03 = imxrt_iomuxc::Pad<AD_B0, 3>;
